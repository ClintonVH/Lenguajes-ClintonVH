...
public class Ejercicio extends javax.swing.JFrame {
 byte mifrase[];
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Escribe una frase");

        Resultado.setText("Transformado");

        Resultado2.setText("Retransformado");
...
byte trato[];
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String frase=textoFrase.getText();
      mifrase =frase.getBytes();
       int i=0;
       Resultado.setText("");
        for(byte x:mifrase){
            String res=Resultado.getText();
            Resultado.setText(""+res+""+x);
        }
        for(int y=0;y<mifrase.length;y++){
            trato[y]=mifrase[y];
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for(byte valor:mifrase){
            micadena.append((char)valor);
            
       }
        Resultado2.setText(micadena.toString());
